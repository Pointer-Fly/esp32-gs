...
#define LCD_CLK 12   // lcd的clk引脚
#define LCD_MOSI 11  // lcd的sda引脚
#define LCD_MISO -1 // lcd的miso引脚

#define LCD_DC 13                                  // lcd的dc引脚
#define LCD_CS 10                                 // lcd的cs引脚
#define LCD_PIXEL_CLOCK_HZ_SPI (80 * 1000 * 1000) // lcd的spi的频率40~80mhz都可以，推荐40mhz

#define LCD_RST 9 // lcd的rst引脚

#define LCD_H_RES 240                       // 宽
#define LCD_V_RES 280                       // 高
...
void st7789_init(void)
{
    ...
    // esp_lcd_panel_swap_xy(panel_handle, LCD_SWAP_XY);               // 设置XY交换
